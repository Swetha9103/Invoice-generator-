...
class InvoiceForm extends React.Component {
  ...
  render() {
    return (<Form onSubmit={this.openModal}>
      <Row>
        <Col md={8} lg={9}>
          <Card className="p-4 p-xl-5 my-3 my-xl-4n bg-primary-subtle border border-primary-subtle rounded-4">
          <h1 className="centered-word">INVOICE</h1>
            ...
            <Button style={{backgroundColor:"rgb(61, 48, 248)",fontSize:"20px"}} variant="primary" type="submit" className="d-block w-100 fw-bold">Review Invoice</Button>
        ...
        <Col md={4} lg={3}>
          <Container style={{backgroundColor:"rgba(154, 106, 173, 0.116)"}}>
          <div className="sticky-top pt-md-3 pt-xl-4">
            <h2 className="fw-bold text-light">Tax and Invoice</h2>
            <Form.Group className="mb-3">
              <Form.Label style={{fontSize:"25px"}}className="fw-bold text-light">Currency:</Form.Label>
            ...
            <Form.Group style={{fontSize:"25px"}}className="my-3">
              <Form.Label className="fw-bold text-light">Tax rate:</Form.Label>
            ...
            <Form.Group style={{fontSize:"25px"}}className="my-3">
              <Form.Label className="fw-bold text-light">Discount rate:</Form.Label>
              <InputGroup className="my-1 flex-nowrap">
                ...
                <InputGroup.Text className="bg-color-red fw-bold text-secondary small">
                  %
                </InputGroup.Text>
              </InputGroup>
            </Form.Group>
